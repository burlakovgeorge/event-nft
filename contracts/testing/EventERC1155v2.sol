...
import "./IEventERC1155v2.sol";

contract EventERC1155v2 is 
    ERC1155Upgradeable,  
    ...
    string public override testField;
    ...
    function createEvent(address eventOwner, string memory _name, string memory _description, string memory email, string memory _eventUri) override external onlyRole(DEFAULT_ADMIN_ROLE) whenNotPaused {
    ...
    function setTest(string memory _newTest) external onlyRole(DEFAULT_ADMIN_ROLE) {
        testField = _newTest;
    }
